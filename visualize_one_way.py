# Visulisierung eines bestimmten ways der XML-Datei über die GUI
...
def open_html_way(bssd, way_id):
    ...
    template.stream(viz=viz_txt).dump(f'output/output_way_{way_id}.html')

    # Open HTML file
    filename = 'file:///' + os.getcwd() + '/output/' + f'output_way_{way_id}.html'
